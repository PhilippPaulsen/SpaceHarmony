export class UIManager {
    ...
    _cacheElements() {
        const ids = [
            ...
            'save-to-library', 'btn-make-compound', 'import-2d-button', 'export-json-button', 'export-obj-button', 'export-png-button',
    ...
    _bindEvents() {
        ...
        this._bindClick('import-2d-button', 'onImportJSON');
